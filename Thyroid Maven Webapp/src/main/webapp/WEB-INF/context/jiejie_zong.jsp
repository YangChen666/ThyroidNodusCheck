...
<div class="admin-content">
	<div class="am-cf am-padding">
   			 <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">分类</strong> / <small>结果展示</small></div>
  	</div>
	<div class="am-tabs am-margin" data-am-tabs>
		...
		<div> <!-- 这个是主div -->
			...
			<div style="border:2px solid #C0C0C0;padding:10px;width:49%;float:left;height:48%;margin-left:2px;height:450px;"> <!-- 这个是放信息的 -->
		        ...
		        <div class="am-g am-margin-top" style="width:100%;">
		            <div>
		             	<span style="font-weight:bold;margin:0;font-size: 50px">分类结果：</span>
		            </div>
