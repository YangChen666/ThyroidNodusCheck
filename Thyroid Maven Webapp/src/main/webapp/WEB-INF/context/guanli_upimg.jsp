...
<div class="admin-content">
	...
	<!-- 表单开始 -->
		<div class="am-cf am-padding">
   			 <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">新增</strong> / <small>用户上传</small></div>
  		</div>	
		<form class="am-form" action="toguanli_upimg.do" enctype="multipart/form-data" method="post">
