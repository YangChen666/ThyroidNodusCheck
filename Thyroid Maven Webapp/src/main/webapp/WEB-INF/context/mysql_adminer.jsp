...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">数据库</strong> / <small>医院数据</small></div>
    </div>
        ...
        <div class="am-fl am-cf">
          <div class="am-btn-toolbar am-fl">
            <div class="am-btn-group am-btn-group-xs">
            	<form action="guanli_upimg.do" style="float: left;">
              ...
              <tr>
                  ...
                  <td>
                      <div class="am-btn-toolbar">
                          <div class="am-btn-group am-btn-group-xs">
                              <form action="select_shiyong.do" style="float: left;">
                              ...
                              <form action="guanli_xuigai_img.do" style="float: left;">
                                  <input name="tupianid" type="text" value="${li.id}" style="display:none;"/>
                                  <input style="color:Black;" class="am-btn am-btn-default am-btn-xs am-text-secondary" type="submit" value="修改"/>
                              </form>
                              <form action="guanli_xuigai_img_delete.do" style="float: left;">
                                  <input name="tupianid" type="text" value="${li.id}" style="display:none;"/>
