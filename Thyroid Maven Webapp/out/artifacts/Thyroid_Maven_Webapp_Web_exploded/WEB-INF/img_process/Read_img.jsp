...
<html>
  ...
  <body class="bg-1">
    ...
    <!-- Wrap all page content here   将所有页面内容都包装在这里-->
    <div id="wrap">

      


      <!-- Make page fluid   使页面流体-->
      <div class="row">
            ...
            <ul class="nav navbar-nav quick-actions">
              ...
              <li class="dropdown divided user" id="current-user">
                ...
                <ul class="dropdown-menu arrow settings">
                  ...
                  <li>
                    <a href="#"><i class="fa fa-user"></i> 1</a>
                  </li>
                  ...
                  <li>
                    <a href="#"><i class="fa fa-envelope"></i> 2 <span class="badge badge-red" id="user-inbox">3</span></a>
                  </li>

                  <li class="divider"></li>

                  <li>
                    <a href="#"><i class="fa fa-power-off"></i> 注销</a>
                  </li>
                </ul>
              </li>
...
<!-- Sidebar 侧边栏-->
            <ul class="nav navbar-nav side-nav" id="sidebar">
              ...
              <li class="navigation" id="navigation">
                <a href="#" class="sidebar-toggle" data-toggle="#navigation">一级下拉1 <i class="fa fa-angle-up"></i></a>
                
                <ul class="menu">
                  <!--一级下拉1-1-->
                  <li class="active">
                    <a href="index.html">
                      <i class="fa fa-tachometer"></i> Ul-1
                      <span class="badge badge-red">2</span> <!--小标题上的数字-->
                    </a>
                  </li>
                  <!--一级下拉1-2-->
                  <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-list"></i> Ul-2 <b class="fa fa-plus dropdown-plus"></b>
                    </a>
                    <ul class="dropdown-menu">
                      <li>  <!--一级下拉1-2 中的小下拉-->
                        <a href="form-elements.html">
                          <i class="fa fa-caret-right"></i> Li-1
                        </a>
                      </li>
                      <li>
                        <a href="validation-elements.html">
                          <i class="fa fa-caret-right"></i> Li-2
                        </a>
                      </li>
                      <li>
                        <a href="form-wizard.html">
                          <i class="fa fa-caret-right"></i> Li-3
                        </a>
                      </li>
                    </ul>
                  </li>
                  ...
                  <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-pencil"></i> Ul-3 <b class="fa fa-plus dropdown-plus"></b>
                    </a>
                    <ul class="dropdown-menu">
                      <li>  <!--一级下拉1-3 中的小下拉-->
                  ...
                  <li> <!--一级下拉1-4-->
                    <a href="buttons.html">
                      <i class="fa fa-tint"></i> Ul-4
                    </a>
                  </li>
                  <li>  <!--一级下拉1-5-->
                    <a href="grid.html">
                      <i class="fa fa-th"></i> Ul-5
                    </a>
                  </li>
                  <!--一级下拉1-6-->
                  <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-th-large"></i> Ul-6 <b class="fa fa-plus dropdown-plus"></b>
                    </a>
                    <ul class="dropdown-menu">
                      <li>  <!--一级下拉1-6 中的小下拉-->
                        <a href="tables.html">
                  ...
                  <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-desktop"></i> Ul-7 <b class="fa fa-plus dropdown-plus"></b>
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li>  <!--一级下拉1-7 中的小下拉-->
                        <a href="page500.html">
                          <i class="fa fa-caret-right"></i> Li-4
                        </a>
                      </li>
                      <li>  <!--一级下拉1-7 中的小下拉-->
                        <a href="page-offline.html">
                          <i class="fa fa-caret-right"></i> Li-5
                        </a>
                      </li>
                      <li>  <!--一级下拉1-7 中的小下拉-->
                        <a href="gallery.html">
                          <i class="fa fa-caret-right"></i> Li-6
                        </a>
                      </li>
                      <li>  <!--一级下拉1-7 中的小下拉-->
                        <a href="timeline.html">
                          <i class="fa fa-caret-right"></i> Li-7
                        </a>
                      </li>
                      <li>
                        <a href="mail.html">  <!--一级下拉1-7 中的小下拉-->
                          <i class="fa fa-caret-right"></i> Li-8
                          <span class="badge badge-red">5</span>
                        </a>
                      </li>
                      <li>  <!--一级下拉1-7 中的小下拉-->
                        <a href="mail-horizontal.html">
                          <i class="fa fa-caret-right"></i> Li-9
                          <span class="label label-greensea">后标</span>
                        </a>
                      </li>
                      <li>  <!--一级下拉1-7 中的小下拉-->
                        <a href="vector-maps.html">
                          <i class="fa fa-caret-right"></i> Li-10
                        </a>
                      </li>
                      <li>  <!--一级下拉1-7 中的小下拉-->
                        <a href="google-maps.html">
                          <i class="fa fa-caret-right"></i> Li-11
                        </a>
                      </li>
                    </ul>
                  </li>
                  ...
                  <li>
                    <a href="widgets.html">
                      <i class="fa fa-play-circle"></i> Ul-8
                    </a>
                  </li>
                  <!--一级下拉1-9-->
                  <li>
                    <a href="charts.html">
                      <i class="fa fa-bar-chart-o"></i> Ul-9
                    </a>
                  </li>
...
<!--一级下拉2  -用来展示数据吧-->
              <li class="summary" id="order-summary">
                <a href="#" class="sidebar-toggle underline" data-toggle="#order-summary">一级下拉2 <i class="fa fa-angle-up"></i></a>
...
<!--一级下拉3-->
              <li class="settings" id="general-settings">
                <a href="#" class="sidebar-toggle underline" data-toggle="#general-settings">一级下拉3 <i class="fa fa-angle-up"></i></a>

                <div class="form-group">
                  <label class="col-xs-8 control-label">开关1</label>
                  <div class="col-xs-4 control-label">
                ...
                <div class="form-group">
                  <label class="col-xs-8 control-label">开关2</label>
                  <div class="col-xs-4 control-label">
                    <div class="onoffswitch greensea">
...
<!-- 正文-主体内容 -->      
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-tachometer"></i> 这里展示在那一级下
            <span>// 副标题</span></h2>
          ...
          <!-- content main container  主要内容-即正文了-->
          <div class="main">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                Collect from <a href="/Thyroid/index" title="网站主页" target="_blank">网站主页</a> - More Templates <a href="/Thyroid/index" target="_blank" title="关于我们">关于我们</a>
