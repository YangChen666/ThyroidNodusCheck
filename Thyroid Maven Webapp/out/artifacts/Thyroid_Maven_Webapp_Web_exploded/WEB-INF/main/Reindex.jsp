...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-5 header-logo">
					<br>
					<a href="index.do"><img src="img/logo.png" alt="" class="img-responsive logo"></a>
				</div>
									                    ...
									                    <section class="box-login v5-input-txt" id="box-login">
									                        <form action="dengluyanzheng.do" id="login_form"  method="post" autocomplete="off">
									                        	...
									                        	<p class="good-tips marginB10"><!-- 判断是那种用户？患者？管理者？  开始-->
									                        		...
									                        		管理员<input type="radio" name="radio1" value="b"/>
									                        	</p><!-- 判断是那种用户？患者？管理者？  结束-->
										                        <p class="good-tips marginB10"><a id="btnForgetpsw" class="fr" href="registered.do">忘记密码？</a>还没有账号？<a href="registered.do" target="_blank" id="btnRegister">立即注册</a></p>
	...
	<section class="service text-center" id="service">
		<div class="container">
			<div class="row">
				<h2>服务</h2>
				<h4>本系统提供甲状腺超声图像的结节计算机辅助诊断（检测）服务</h4>
		...
		<div class="container">
			<div class="row">
				<div class="team-heading text-center">
					<h2>团队</h2>
					<h4>自2017年9月以来，一直致力于超声甲状腺图像的结节检测研究    --郑斌</h4>
				</div>
