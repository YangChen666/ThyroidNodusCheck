...
<div id="tab">
  ...
  <div class="tab_box"> 
    ...
    <div>
      ...
      <form action="tologin.do" method="post" class="stu_login_error">
        <div id="username">
          <label>账&nbsp;&nbsp;&nbsp;号：</label>
          <input type="text" id="stu_username_hide" name="username" value="输入账号" nullmsg="账号不能为空！" datatype="s6-18" errormsg="账号范围在6~18个字符之间！" sucmsg="账号验证通过！"/>
        ...
        <div>
        	<button type="button">游客进入</button>
        </div>
      </form>
    </div>
   <!-- 患者登录结束-->
    ...
    <div class="hide">
     <div class="tea_error_box"></div>
      <form action="" method="post" class="tea_login_error">
        <div id="username">
          <label>职工号：</label>
          <input type="text" id="tea_username_hide" name="username" value="输入账号" nullmsg="账号不能为空！" datatype="s6-18" errormsg="账号范围在6~18个字符之间！" sucmsg="账号验证通过！"/>
          <!--ajaxurl="demo/valid.jsp"--> 
        </div>
        <div id="password">
          <label>密&nbsp;&nbsp;&nbsp;码：</label>
...
<div class="bottom">©2019 Leting <a href="javascript:;" target="_blank">关于</a> <span>Thyroid_classification_system</span></div>
<div class="screenbg">
  <ul>
