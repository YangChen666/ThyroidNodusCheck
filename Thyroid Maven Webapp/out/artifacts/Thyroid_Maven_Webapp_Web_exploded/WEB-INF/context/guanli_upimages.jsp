...
<div class="admin-content">
	...
	<!-- 表单开始 -->
		<div class="am-cf am-padding">
   			 <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">新增</strong> / <small>医院数据</small></div>
  		</div>	
		<form class="am-form" action="toguanli_upimages.do" enctype="multipart/form-data" method="post">
          	<div class="am-g am-margin-top">
	            <div class="am-u-sm-2 am-text-right">
	             	 文件名称
	            </div>
	            <div class="am-u-sm-4">
	            	<input type="text" name="name" value="暂时取消手动输入文件名，采用源文件名" class="am-input-sm"/></td>
	            </div>
