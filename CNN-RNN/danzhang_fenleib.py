...
if __name__ == '__main__':
	...
	model=ree()
	########################
	model.load_weights('E:\\IntelliJ Projects\\Thyroid\\model\\secondStage.hdf5')
	...
	if(preds[0][1]>preds[0][0]):
		#liang xing
		output = open('E:/IntelliJ Projects/Thyroid/fenleib.txt', 'w')
		output.write("l");#:liang xing
		output.close();
	    # print ("liangxing")
	else:
		#e xing
		output = open('E:/IntelliJ Projects/Thyroid/fenleib.txt', 'w')
		output.write("e");#e:e xing
		output.close();
	    # print ("e xing")
